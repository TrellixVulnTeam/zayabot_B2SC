...
exports.makeWASocket = (...args) => {
    ...
    conn.logger = {
        ...conn.logger,
        info(...args) { console.log(chalk.keyword('orange')(`[NOTIFICAÇÃO]`), chalk.bold.rgb(239, 225, 3)(...args)) },
        error(...args) { console.log(chalk.bold.rgb(247, 38, 33)(`ERRO [${chalk.rgb(255, 255, 255)(new Date())}]:`), chalk.rgb(255, 38, 0)(...args)) },
        warn(...args) { console.log(chalk.bold.rgb(248,4,4)(`[ALERTA]`), chalk.bold.rgb(252, 88, 88)(...args)) }
    }
