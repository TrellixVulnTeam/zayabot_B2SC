...
module.exports = {
    ...
    async participantsUpdate({ id, participants, action }) {
            ...
            case 'remove':
                if (chat.welcome) {
                    ...
                    for (let user of participants) {
                        let pp = './arquivos/imagens/avatarHandler/avatar.jpg'
                        try {
        ...
        switch(command) {
            case 'oi' || '.' || 'ola' || 'eae' :
                m.reply('Utilize /menu para mais infomações.')
                break
        }
    },
...
global.dfail = (type, m, conn) => {
    let msg = {
        rowner: 'Este comando só pode ser usado por *desenvolvedores*!',
        owner: `Este comando só pode ser usado pelos meu desenvolvedores!
Use o comando /desenvolvedores caso queira falar com ele.`,
        mods: 'Este comando só pode ser usado por Moderadores!',
        premium: 'Este comando é apenas para membros _*premium*_ !',
        group: 'Este comando só pode ser usado em grupos!',
        private: 'Este comando só pode ser usado no privado',
        admin: 'Este comando é apenas para os Admins desse grupo!',
        botAdmin: 'Preciso ser Admin para usar este comando!',
        unreg: 'Registre-se para usar este recurso digitando:\n\n*/registrar nome.idade*\n\nExemplo: */daftar zaya.16*',
...
fs.watchFile(file, () => {
    fs.unwatchFile(file)
    console.log(chalk.redBright("Arquivo atualizado ->> 'handler.js'"))
